...
Basic Report Export
-------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637873258#report/3842/c4d24ef0-4900-4a22-b6c4-da8cb19b3823)
  * Load the report
  * Click export
  * Select PDF
  * Select Portrait
...
----------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=2023050310363727195#report/3842/4dfc02f0-36d3-4b63-b694-702eb9874e1e)
  * Load the report
...
--------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637945773#report/3842/c4d24ef0-4900-4a22-b6c4-da8cb19b3823)
  * Load the report
...
----------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637864039#report/3842/c4d24ef0-4900-4a22-b6c4-da8cb19b3823)
  * Load the report
...
Export Excel
------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637576547#report/3842/c4d24ef0-4900-4a22-b6c4-da8cb19b3823)
  * Load the report
...
--------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637504519#report/3842/c4d24ef0-4900-4a22-b6c4-da8cb19b3823)
  * Load the report
  * Click export
...
-----------------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/DashboardDetail.aspx?tabid=912b9658-acd4-4ead-8ec2-debb18b8fb81&chartid=graph4&_qa=20230503103637210971)
...
-------------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637921282#report/3842/4dfc02f0-36d3-4b63-b694-702eb9874e1e)
  * Load the report
  * Click print preview
  * Click on the cell that says "Jim Lewis"
  * Load the detail report
...
-------------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/DashboardDetail.aspx?tabid=912b9658-acd4-4ead-8ec2-debb18b8fb81&chartid=graph4&_qa=20230503103637972030)
...
-----------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637764934#report/3842/c4d24ef0-4900-4a22-b6c4-da8cb19b3823)
  * Load the report
  * Click print preview
...
Basic
-----
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637976385#report/3842/4a4dffc2-b9be-4d51-b421-1270f726579e)
  * Load the report
  * Click print preview
...
C2G
---
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=2023050310363760196#report/3842/ff8b70b5-710c-4fc1-a2fe-a1f94515e0f0)
  * Load the report
  * Click print preview
...
Drill From Summary To Detail
----------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637683299#report/3842/4dfc02f0-36d3-4b63-b694-702eb9874e1e)
  * Load the report
  * Click print preview
...
Fetch New Data
--------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637772150#report/3842/c89ff976-602d-45dd-a3a6-5b2e2c890c54)
  * Load the report
  * Click print preview
...
---------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/DashboardDetail.aspx?tabid=912b9658-acd4-4ead-8ec2-debb18b8fb81&chartid=graph4&_qa=20230503103637548932)
  * Load the dashboard detail
  * Click print preview
...
Otfa
----
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230427221131472541&_qa=202305031036375411#report/3842/e90f0da4-2f0d-4adb-ad44-a956636d9157)
  * Load the report
  * Click print preview
...
-------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=2023050310363717012#report/3842/907a4d8d-1bdd-4faf-87f0-3959bbfce283)
  * Load the report
  * Click print preview
...
--------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230427221131472541&_qa=20230503103637320244#report/3842/10912a53-8ab8-4ac6-a0c8-b8d08777ecfe)
  * Load the report
  * Click print preview
...
------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637808210#report/3842/c4d24ef0-4900-4a22-b6c4-da8cb19b3823)
  * Load the report
  * Click print preview
...
------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637802420#report/3842/4dfc02f0-36d3-4b63-b694-702eb9874e1e)
  * Load the report
  * Click print preview
...
----------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637874221#report/3842/cf34688e-00a2-4338-8db9-21ea86045149)
  * Load the report
  * Click print preview
...
---------------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637407409#report/3842/8d51f1e9-e263-405e-94ce-c89ef075261a)
  * Load the report
  * Click print preview
...
Toggle Sort Options
-------------------
  * [(link to test)](https://webapp.brightmetrics.com/UI-2/pages/Reports.aspx?_qa=20230503103637428812#report/3842/c89ff976-602d-45dd-a3a6-5b2e2c890c54)
  * Load the report
  * Click print preview
